...
function App() {
	...
	return (
		<div className='grid relative min-h-screen grid-cols-7 grid-rows-[3rem_1fr] gap-1 px-4 py-2 App bg-blue-dark xl:px-6 xl:py-4 xl:gap-2 overflow-y-scroll scrollbar scroll-thumb-yellow-dark scrollbar-track-transparent scroll-thumb-rounded-full max-w-screen-2xl'>
			<Navigation />
